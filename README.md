...
| `key_manual` | `hboot.conf` | Key for manual boot browser (default: `m`) |
| `key_firmware` | `hboot.conf` | Key for UEFI firmware setup (default: `f`) |
| `key_reboot` | `hboot.conf` | Key to reboot (default: `r`) |
| `key_shutdown` | `hboot.conf` | Key to shutdown (default: `s`) |
| `key_backup` | `hboot.conf` | Key to restore backup entries (default: `b`) |
